...
import { User, Nomination, Attendance, Institution } from '../../types';
import { usersApi, nominationsApi, attendanceApi, institutionsApi, BASE_URL } from '../../services/api';
import { Avatar, AvatarFallback, AvatarImage } from '../components/ui/avatar';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '../components/ui/card';
import { Button } from '../components/ui/button';
import { ArrowLeft, Mail, Phone, MapPin, Shield, Calendar, CheckCircle2, XCircle, Clock, Briefcase, Building } from 'lucide-react';
...
const UserDetails: React.FC = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                setLoading(true);
                // Fetch basic user profile and institutions concurrently
    ...
    const getInstitutionName = (institutionId: any) => {
        if (!institutionId) return 'Not assigned';
        ...
        const inst = institutions.find(i => i.id === id || (i as any)._id === id);
        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-10">
            ...
            <Card className="overflow-hidden border-border/50 shadow-sm">
                ...
                <CardContent className="p-6 pt-0 relative sm:px-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 pt-6 border-t border-border/50 mt-6">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Operational Rank</p>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium">{getInstitutionName(user.institutionId)}</p>
                            </div>
                        </div>
