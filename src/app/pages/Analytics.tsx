              ...
              <div>
                ...
                <ResponsiveContainer width="100%" height={350}>
                  <BarChart data={trainingAnalytics.byInstitution}>
                    ...
                    <Bar dataKey="nominated" fill="rgba(255,255,255,0.2)" radius={[4, 4, 0, 0]} barSize={30} name="Nominated" />
                    <Bar dataKey="attended" fill="#ff0000" radius={[4, 4, 0, 0]} barSize={30} name="Attended" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </>
