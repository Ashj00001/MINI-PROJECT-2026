                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            {/* Operational Rank */}
                            <div className="space-y-2">
                                <Label htmlFor="designation" className="text-sm font-medium">{t('auth.register.designation', 'Operational Rank')}</Label>
                                <Select onValueChange={handleDesignationChange} value={formData.designation}>
                                    <SelectTrigger className="h-11 bg-background relative pl-10" id="designation">
                                        <Briefcase className="absolute left-3 top-3.5 size-4 text-muted-foreground z-10 pointer-events-none" />
                                        <SelectValue placeholder="Medical Officer" />
                                    </SelectTrigger>
                                    <SelectContent className="max-h-[300px]">
                                        {OPERATIONAL_RANKS.map((rank) => (
